  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <TextField label="Guests" value={guests} onChange={(e) => setGuests(e.target.value)} />
        <TextField label="Minimum Bedrooms" value={bedrooms} onChange={(e) => setBedrooms(e.target.value)} />
        <TextField label="Min Rating" value={minRating} onChange={(e) => setMinRating(e.target.value)} />
        <TextField label="Min Attacks Same Country" value={minAttacksSameCountry} onChange={(e) => setMinAttacksSameCountry(e.target.value)} />
